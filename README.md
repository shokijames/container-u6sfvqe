...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-u6sfvqe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-u6sfvqe.containers.anotherwebservice.com/
...
```
git clone git@github.com:shokijames/container-u6sfvqe.git
cd container-u6sfvqe
```
...
```
docker attach container-u6sfvqe
```
